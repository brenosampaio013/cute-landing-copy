...
const WHATSAPP_URL = `https://api.whatsapp.com/send?phone=5513998068265&text=${encodeURIComponent(
...
export function WhatsappFab() {
  return (
    ...
    >
      <span className="pointer-events-none absolute inset-0 animate-ping rounded-full bg-[#25D366]/40" aria-hidden="true" />
